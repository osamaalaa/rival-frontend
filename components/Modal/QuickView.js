...
class QuickView extends Component {
    ...
    handleAddToCartFromView = () => {
        this.props.addQuantityWithNumber(this.props.idd, this.state.qty , this.props.title ,  this.props.availability); 
        // console.log("cartss" + this.props.title);
    ...
    IncrementItem = () => {
        this.setState(prevState => {
            if(prevState.qty < this.state.max ) {
                return {
                    qty: prevState.qty + 1
                }
            } else {
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="product-content">
                                    ...
                                    <ul className="product-info">
                                        <li>
                                            <span>ID:</span> <Link href="#"><a>{this.props.idd}</a></Link>
                                        </li>
                                        <li>
                                            <span>Availability:</span> <Link href="#"><a>{this.props.availability}</a></Link>
                                        </li>
                                        <li>
                                            <span>Product Type:</span> <Link href="#"><a>{this.props.title}</a></Link>
                                        </li>
                                    </ul>
...
const mapDispatchToProps= (dispatch)=>{
    return {
        addQuantityWithNumber: (id, qty , title , availability) => {dispatch(addQuantityWithNumber(id, qty , title , availability))}
    }
}
