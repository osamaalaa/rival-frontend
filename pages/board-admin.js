...
//                                            <h2><span className="dot"></span>Board Admin</h2>
//                                        </div>
...
//                                                                       <input className="btn btn-primary ml-2" type="reset" onClick={this.resetForm} value="Reset"/>
//                                                                   </div>
//                                                               </ValidationForm>
  ...
  constructor(props) {
    ...
    //  ,
      ...
      componentDidMount() {
        ...
        //   axios.get('http://localhost:4000/RivalServices/Sales')
        //   .then(res => {
        //     let chart = {...this.state.chartData};
        //     chart.labels[0] = res.data.result[0].created_at;
        //     // // .datasets.data
        //     chart.datasets[0].data[0] = res.data.count;
     
        //     this.setState({
        //     chartData: { ...this.state.chartData, chart }
              
                      
        //             });
        //             console.log(res.data.result[0].created_at);
                ...
                <section className="contact-area">         
                    <div className="contact-form">
                      <div className="section-title  mb-4">
                          <h2 className="dot mt-4"><span className="dot"></span>Sales</h2>
                      </div>
                      {/* Bar that gets the data from API */}

                      {/* <Bar data={this.state.chartData} width={60} height={20}
                        options={{
                          legend:{
                            display:true,
                            position:'bottom',
                    ...
                    {/* Dummy Bar */}
                      <Bar data={this.state.data} width={60} height={20}
                        options={{
                          legend:{
                            display:true,
                            position:'bottom',
